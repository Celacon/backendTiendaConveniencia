...
public class LoginInService {
	...
	public HashMap<String, String> validation (@RequestBody LoginFrm loginForm) {
		...
		String idPersona=String.valueOf(intIdPersona);
		...
		if (!usuario.isEmpty()) {
			...
			switch (usuario.get(0).getIdRol())
			{
				...
				case 3: {
							rol = "cajero";
							 VariablesGlobales.idRolSesion = "cajero";
			...
			System.out.println(usuarioIngresa);
			usuarioIngresa.put("rol", rol);
			
			usuarioIngresa.put("idPersona", idPersona);
