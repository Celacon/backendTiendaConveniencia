...
public class SubcategoriaService {
	...
	@DeleteMapping(path ="/eliminar/{id_subcategoria}")
	public void eliminar (@PathVariable("id_subcategoria") Integer idSubcategoria) {
		...
		System.out.print("Registro eliminado. Codigo ----" + idSubcategoria);
