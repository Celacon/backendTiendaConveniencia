...
import com.grupo2.tiendaConveniencia.entity.VTurnoTienda;
import com.grupo2.tiendaConveniencia.repository.VTurnoTiendaRepository;

@RestController
@RequestMapping("/vTurnoTienda")
@CrossOrigin
public class VTurnoTiendaService {
    
    @Autowired
    VTurnoTiendaRepository vTurnoTiendaRepository;
    @Value("${rolUsuarioLogueado}")
    public String rolUsrLog;
    
    @GetMapping(path = "/buscar")
    public List<VTurnoTienda> buscar() {
        ...
        return vTurnoTiendaRepository.findAll();
    }
